function calcular() {
  ...
  document.getElementById('tiranteCritico').textContent = YT.toFixed(4);
  document.getElementById('perimetro').textContent = P1.toFixed(4);
  document.getElementById('areaHidraulica').textContent = AT.toFixed(4);
  document.getElementById('radioHidraulico').textContent = R1.toFixed(4);
  document.getElementById('espejoAgua').textContent = TT.toFixed(4);
  document.getElementById('velocidad').textContent = VT.toFixed(4);
  document.getElementById('froude').textContent = F1.toFixed(4);
  document.getElementById('energia').textContent = E1.toFixed(4);
