function calcular() {
  ...
  while (true) {
    ...
    document.getElementById("tiranteNormal").innerHTML = "Tirante Normal (m): " + YP.toFixed(4);
    document.getElementById("perimetro").innerHTML = "Perímetro Mojado (m): " + PP.toFixed(4);
    document.getElementById("areaHidraulica").innerHTML = "Área Hidráulica (m²): " + AP.toFixed(4);
    document.getElementById("radioHidraulico").innerHTML = "Radio Hidráulico (m): " + (AP/PP).toFixed(4);
    document.getElementById("focoParabola").innerHTML = "Foco de la parábola (m): " + KP.toFixed(4);
    document.getElementById("espejoAgua").innerHTML = "Espejo de Agua (m): " + TP.toFixed(4);
    document.getElementById("velocidad").innerHTML = "Velocidad (m/s): "  + VP.toFixed(4);
    document.getElementById("numeroFroude").innerHTML = "Número de Froude: " + F2P.toFixed(4) ;
    document.getElementById("energia").innerHTML = "Energía Específica (m-kg/kg): " + EP.toFixed(4) ;
