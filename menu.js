...
const d_Dagan_sete = document.querySelectorAll(".d_dagan_ete");
const d_glover_za = document.querySelectorAll(".d_glover_za");
const d_glover_te = document.querySelectorAll(".d_glover_te");
const d_jenab_za = document.querySelectorAll(".d_jenab_za");
const d_jenab_te = document.querySelectorAll(".d_jenab_te");
const eH_t_r_hb = document.querySelectorAll(".r_hb");
const hooghoudt_za = document.querySelectorAll(".hooghoudt_za");
const eh_cr = document.querySelectorAll(".eh_cr");
...
const Experimento_drenajes_dagan_sete = document.getElementById("Experimento_drenajes_dagan_sete");
const Experimento_drenajes_glover_za = document.getElementById("Experimento_drenajes_glover_za");
const Experimento_drenajes_glover_te = document.getElementById("Experimento_drenajes_glover_te");
const Experimento_drenajes_jenab_za = document.getElementById("Experimento_drenajes_jenab_za");
const Experimento_drenajes_jenab_te = document.getElementById("Experimento_drenajes_jenab_te");
const Experimento_elementosH_tuneles_r_hb = document.getElementById("Experimento_elementosH_tuneles_r_hb");
const Experimento_drenajes_hooghoudt_za = document.getElementById("Experimento_drenajes_hooghoudt_za");
const Experimento_elementosH_tuneles_cr = document.getElementById("Experimento_elementosH_tuneles_cr");
...
const img_Experimento_salto_t = document.getElementById("img_Experimento_salto_t");
const img_Experimento_drenajes_dZa = document.getElementById("img_Experimento_drenajes_dZa");
const img_Experimento_drenajes_dTe = document.getElementById("img_Experimento_drenajes_dTe");
const img_Experimento_drenajes_dagan_sh = document.getElementById("img_Experimento_drenajes_dagan_sh");
const img_Experimento_drenajes_dagan_sete = document.getElementById("img_Experimento_drenajes_dagan_sete");
const img_Experimento_drenajes_glover_za = document.getElementById("img_Experimento_drenajes_glover_za");
const img_Experimento_drenajes_glover_te = document.getElementById("img_Experimento_drenajes_glover_te");
const img_Experimento_drenajes_jenab_za = document.getElementById("img_Experimento_drenajes_jenab_za");
const img_Experimento_drenajes_jenab_te = document.getElementById("img_Experimento_drenajes_jenab_te");
const img_Experimento_elementosH_tuneles_r_hb = document.getElementById("img_Experimento_elementosH_tuneles_r_hb");
const img_Experimento_drenajes_hooghoudt_za = document.getElementById("img_Experimento_drenajes_hooghoudt_za");
const img_Experimento_elementosH_tuneles_cr = document.getElementById("img_Experimento_elementosH_tuneles_cr");
...
d_Dagan_sete.forEach(function (element) {
  element.addEventListener("click", () => {
    bridge(Experimento_drenajes_dagan_sete, i);
    cF_Off.style.pointerEvents = "none";
    cF_Off.style.animation = "moveFadeOut 0.7s forwards";
    cF_Off.style.opacity = "0";
    Experimento_drenajes_dagan_sete.style.pointerEvents = "auto";
    Experimento_drenajes_dagan_sete.style.opacity = "100";
    Experimento_drenajes_dagan_sete.style.animation = "moveFadeOut2 0.7s forwards";
    document.getElementById("encabe").textContent = "DAGAN";
  });
});


img_Experimento_drenajes_dagan_sete.addEventListener("click", () => {
  vector = [];
  Experimento_drenajes_dagan_sete.style.pointerEvents = "none";
  cF_Off.style.pointerEvents = "auto";
  cF_Off.style.animation = "moveFadeOut2 0.7s forwards";
  cF_Off.style.opacity = "100";
  Experimento_drenajes_dagan_sete.style.animation = "moveFadeOut 0.7s forwards";
  setTimeout(function () {
    Experimento_drenajes_dagan_sete.style.opacity = "0";
  }, 700);
  setTimeout(function () {
    document.getElementById("encabe").textContent = "LISTA DE CONTENIDO";
  }, 200);
...
d_glover_za.forEach(function (element) {
  element.addEventListener("click", () => {
    bridge(Experimento_drenajes_glover_za,i);
    cF_Off.style.pointerEvents = "none";
    cF_Off.style.animation = "moveFadeOut 0.7s forwards";
    cF_Off.style.opacity = "0";
    Experimento_drenajes_glover_za.style.pointerEvents = "auto";
    Experimento_drenajes_glover_za.style.opacity = "100";
    Experimento_drenajes_glover_za.style.animation = "moveFadeOut2 0.7s forwards";
    document.getElementById("encabe").textContent = " GLOVER-DUMM";
  });
});

img_Experimento_drenajes_glover_za.addEventListener("click", () => {
  vector = [];
  Experimento_drenajes_glover_za.style.pointerEvents = "none";
  cF_Off.style.pointerEvents = "auto";
  cF_Off.style.animation = "moveFadeOut2 0.7s forwards";
  cF_Off.style.opacity = "100";
  Experimento_drenajes_glover_za.style.animation = "moveFadeOut 0.7s forwards";
  setTimeout(function () {
    Experimento_drenajes_glover_za.style.opacity = "0";
  }, 700);
  setTimeout(function () {
    document.getElementById("encabe").textContent = "LISTA DE CONTENIDO";
  }, 200);
...
d_glover_te.forEach(function (element) {
  element.addEventListener("click", () => {
    bridge(Experimento_drenajes_glover_te,i);
    cF_Off.style.pointerEvents = "none";
    cF_Off.style.animation = "moveFadeOut 0.7s forwards";
    cF_Off.style.opacity = "0";
    Experimento_drenajes_glover_te.style.pointerEvents = "auto";
    Experimento_drenajes_glover_te.style.opacity = "100";
    Experimento_drenajes_glover_te.style.animation = "moveFadeOut2 0.7s forwards";
    document.getElementById("encabe").textContent = " GLOVER-DUMM";
  });
});

img_Experimento_drenajes_glover_te.addEventListener("click", () => {
  vector = [];
  Experimento_drenajes_glover_te.style.pointerEvents = "none";
  cF_Off.style.pointerEvents = "auto";
  cF_Off.style.animation = "moveFadeOut2 0.7s forwards";
  cF_Off.style.opacity = "100";
  Experimento_drenajes_glover_te.style.animation = "moveFadeOut 0.7s forwards";
  setTimeout(function () {
    Experimento_drenajes_glover_te.style.opacity = "0";
  }, 700);
  setTimeout(function () {
    document.getElementById("encabe").textContent = "LISTA DE CONTENIDO";
  }, 200);
...
d_jenab_za.forEach(function (element) {
  element.addEventListener("click", () => {
    bridge(Experimento_drenajes_jenab_za,i);
    cF_Off.style.pointerEvents = "none";
    cF_Off.style.animation = "moveFadeOut 0.7s forwards";
    cF_Off.style.opacity = "0";
    Experimento_drenajes_jenab_za.style.pointerEvents = "auto";
    Experimento_drenajes_jenab_za.style.opacity = "100";
    Experimento_drenajes_jenab_za.style.animation = "moveFadeOut2 0.7s forwards";
    document.getElementById("encabe").textContent = "JENAB";
  });
});


img_Experimento_drenajes_jenab_za.addEventListener("click", () => {
  vector = [];
  Experimento_drenajes_jenab_za.style.pointerEvents = "none";
  cF_Off.style.pointerEvents = "auto";
  cF_Off.style.animation = "moveFadeOut2 0.7s forwards";
  cF_Off.style.opacity = "100";
  Experimento_drenajes_jenab_za.style.animation = "moveFadeOut 0.7s forwards";
  setTimeout(function () {
    Experimento_drenajes_jenab_za.style.opacity = "0";
  }, 700);
  setTimeout(function () {
    document.getElementById("encabe").textContent = "LISTA DE CONTENIDO";
  }, 200);
...
d_jenab_te.forEach(function (element) {
  element.addEventListener("click", () => {
    bridge(Experimento_drenajes_jenab_te,i);
    cF_Off.style.pointerEvents = "none";
    cF_Off.style.animation = "moveFadeOut 0.7s forwards";
    cF_Off.style.opacity = "0";
    Experimento_drenajes_jenab_te.style.pointerEvents = "auto";
    Experimento_drenajes_jenab_te.style.opacity = "100";
    Experimento_drenajes_jenab_te.style.animation = "moveFadeOut2 0.7s forwards";
    document.getElementById("encabe").textContent = "JENAB";
  });
});

img_Experimento_drenajes_jenab_te.addEventListener("click", () => {
  vector = [];
  Experimento_drenajes_jenab_te.style.pointerEvents = "none";
  cF_Off.style.pointerEvents = "auto";
  cF_Off.style.animation = "moveFadeOut2 0.7s forwards";
  cF_Off.style.opacity = "100";
  Experimento_drenajes_jenab_te.style.animation = "moveFadeOut 0.7s forwards";
  setTimeout(function () {
    Experimento_drenajes_jenab_te.style.opacity = "0";
  }, 700);
  setTimeout(function () {
    document.getElementById("encabe").textContent = "LISTA DE CONTENIDO";
  }, 200);
...
eH_t_r_hb.forEach(function (element) {
  element.addEventListener("click", () => {
    bridge(Experimento_elementosH_tuneles_r_hb,i);
    cF_Off.style.pointerEvents = "none";
    cF_Off.style.animation = "moveFadeOut 0.7s forwards";
    cF_Off.style.opacity = "0";
    Experimento_elementosH_tuneles_r_hb.style.pointerEvents = "auto";
    Experimento_elementosH_tuneles_r_hb.style.opacity = "100";
    Experimento_elementosH_tuneles_r_hb.style.animation = "moveFadeOut2 0.7s forwards";
    document.getElementById("encabe").textContent = "TÚNELES";
  });
});

img_Experimento_elementosH_tuneles_r_hb.addEventListener("click", () => {
  vector = [];
  Experimento_elementosH_tuneles_r_hb.style.pointerEvents = "none";
  cF_Off.style.pointerEvents = "auto";
  cF_Off.style.animation = "moveFadeOut2 0.7s forwards";
  cF_Off.style.opacity = "100";
  Experimento_elementosH_tuneles_r_hb.style.animation = "moveFadeOut 0.7s forwards";
  setTimeout(function () {
    Experimento_elementosH_tuneles_r_hb.style.opacity = "0";
  }, 700);
  setTimeout(function () {
    document.getElementById("encabe").textContent = "LISTA DE CONTENIDO";
  }, 200);
...
hooghoudt_za.forEach(function (element) {
  element.addEventListener("click", () => {
    bridge(Experimento_drenajes_hooghoudt_za,i);
    cF_Off.style.pointerEvents = "none";
    cF_Off.style.animation = "moveFadeOut 0.7s forwards";
    cF_Off.style.opacity = "0";
    Experimento_drenajes_hooghoudt_za.style.pointerEvents = "auto";
    Experimento_drenajes_hooghoudt_za.style.opacity = "100";
    Experimento_drenajes_hooghoudt_za.style.animation = "moveFadeOut2 0.7s forwards";
    document.getElementById("encabe").textContent = "HOOGHOUDT";
  });
});

img_Experimento_drenajes_hooghoudt_za.addEventListener("click", () => {
  vector = [];
  Experimento_drenajes_hooghoudt_za.style.pointerEvents = "none";
  cF_Off.style.pointerEvents = "auto";
  cF_Off.style.animation = "moveFadeOut2 0.7s forwards";
  cF_Off.style.opacity = "100";
  Experimento_drenajes_hooghoudt_za.style.animation = "moveFadeOut 0.7s forwards";
  setTimeout(function () {
    Experimento_drenajes_hooghoudt_za.style.opacity = "0";
  }, 700);
  setTimeout(function () {
    document.getElementById("encabe").textContent = "LISTA DE CONTENIDO";
  }, 200);
...
eh_cr.forEach(function (element) {
  element.addEventListener("click", () => {
    bridge(Experimento_elementosH_tuneles_cr,i);
    cF_Off.style.pointerEvents = "none";
    cF_Off.style.animation = "moveFadeOut 0.7s forwards";
    cF_Off.style.opacity = "0";
    Experimento_elementosH_tuneles_cr.style.pointerEvents = "auto";
    Experimento_elementosH_tuneles_cr.style.opacity = "100";
    Experimento_elementosH_tuneles_cr.style.animation = "moveFadeOut2 0.7s forwards";
    document.getElementById("encabe").textContent = "TUNELES";
  });
});

img_Experimento_elementosH_tuneles_cr.addEventListener("click", () => {
  vector = [];
  Experimento_elementosH_tuneles_cr.style.pointerEvents = "none";
  cF_Off.style.pointerEvents = "auto";
  cF_Off.style.animation = "moveFadeOut2 0.7s forwards";
  cF_Off.style.opacity = "100";
  Experimento_elementosH_tuneles_cr.style.animation = "moveFadeOut 0.7s forwards";
  setTimeout(function () {
    Experimento_elementosH_tuneles_cr.style.opacity = "0";
  }, 700);
  setTimeout(function () {
    document.getElementById("encabe").textContent = "LISTA DE CONTENIDO";
  }, 200);
