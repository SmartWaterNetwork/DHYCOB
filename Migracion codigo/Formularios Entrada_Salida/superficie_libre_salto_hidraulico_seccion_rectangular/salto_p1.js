function calcular() {
    ...
    document.getElementById('tiranteConjugado').textContent = 'Tirante conjugado (m): ' + Y2Trapezio.toFixed(4);
    document.getElementById('numeroFroudeConjugado').textContent = 'Número de Froude conjugado: ' + ((QTrapezio / A2Trapezio) / Math.sqrt(9.81 * Y2Trapezio)).toFixed(3);
    document.getElementById('alturaSalto').textContent = 'Altura del salto (m): ' + Y3Trapezio.toFixed(4);
    document.getElementById('longitudSalto').textContent = 'Longitud del salto (m): ' + (Y3Trapezio * 5).toFixed(4);
    document.getElementById('perdidaEnergia').textContent = 'Pérdida de energía (m): ' + (E2Trapezio - E1Trapezio).toFixed(4);
    document.getElementById('pendienteCanal').textContent = 'Pendiente del canal: ' + JTrapezio.toFixed(4);
