document.addEventListener("DOMContentLoaded", function() {
    ...
    function Button1_Click() {
        if (elements.tbaltsedmet1.value !== '' && elements.tbaltbordlibmet1.value !== '' && elements.tbntanquesmet1.value !== '' &&
            elements.tbhabmet1.value !== '' && elements.tbdotmet1.value !== '' && elements.tbaltbordlibmet2.value !== '' && elements.tbaltbordlibmet5.value !== '') {
    ...
    function Button6_Click() {
        elements.tbhabmet1.value = 0.005;
        elements.tbdotmet1.value = 5;
        elements.tbntanquesmet1.value = 1.5;
        elements.tbaltsedmet1.value = 1.1;
        elements.tbaltbordlibmet1.value = 0.8;
        elements.tbaltbordlibmet2.value = 0.1;
        elements.tbaltbordlibmet5.value = 2;
    }
